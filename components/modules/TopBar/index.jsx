                ...
                <div className={classes.topBarContainer}>
                    ...
                    <div className={classes.booksCategoriesContainer}>
                        <div className={classes.categories}>
                            ...
                            <div className={classes.categoryDetails}>Adventurous Eating</div>
                        </div>
                        <div className={classes.categories}>
                        <img src={book2.src} className={classes.categoriesImg} />
                        <div className={classes.categoryDetails}>Girls At The Golden City </div>
                        </div>
                        <div className={classes.categories}>
                        <img src={book3.src} className={classes.categoriesImg} />
                        <div className={classes.categoryDetails}>Endless Summer</div>
                        </div>
